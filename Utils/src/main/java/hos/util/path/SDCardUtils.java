...
public class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) getApplication().getSystemService(Context.STORAGE_SERVICE);
    ...
    public static long getExternalTotalSize() {
        return FileSizeUtils.getFsTotalSize(getSDCardPathByEnvironment());
    }
    ...
    public static long getExternalAvailableSize() {
        return FileSizeUtils.getFsAvailableSize(getSDCardPathByEnvironment());
    }
    ...
    public static long getInternalTotalSize() {
        return FileSizeUtils.getFsTotalSize(Environment.getDataDirectory().getAbsolutePath());
    }
    ...
    public static long getInternalAvailableSize() {
        return FileSizeUtils.getFsAvailableSize(Environment.getDataDirectory().getAbsolutePath());
    }
    ...
    public static class SDCardInfo {
        ...
        SDCardInfo(String path, String state, boolean isRemovable) {
            ...
            this.totalSize = FileSizeUtils.getFsTotalSize(path);
            this.availableSize = FileSizeUtils.getFsAvailableSize(path);
        }
        ...
        public String toString() {
            return "SDCardInfo {" +
                    ...
                    ", totalSize = " + Formatter.formatFileSize(getApplication(), totalSize) +
                    ", availableSize = " + Formatter.formatFileSize(getApplication(), availableSize) +
                    '}';
        }
    }
}
